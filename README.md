...
|-----------|------------|-------------|
| ![t=0](plate_analysis/docs/images/grid_t000.png) | ![t=60](plate_analysis/docs/images/grid_t060.png) | ![t=175](plate_analysis/docs/images/grid_t175.png) |

**Latest summary** (final timepoint):

![Summary](plate_analysis/docs/images/example_summary.png)
